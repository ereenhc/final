...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; background: #faebd7; margin: 0; padding: 0; display: flex; min-height: 100vh;}
        .main-container { flex-grow: 1; padding: 40px; display: flex; flex-direction: column; align-items: center; justify-content: center; width:100vw;}
        h2 { text-align: center; margin-bottom: 20px;}
        #chat-container { display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%; }
        #chat-box { width: 70%; height: 500px; border: 2px solid #ccc; overflow-y: scroll; padding: 20px; background-color: rgb(255, 252, 240); margin-bottom: 20px; border-radius: 5px; }
        .message { margin-bottom: 10px; display: flex; align-items: center; justify-content: flex-start; }
        #username-select-form { display: flex; gap: 12px; margin-bottom: 30px; }
        #username-input { padding: 10px; font-size: 16px; width: 200px; }
        #set-username-btn { padding: 10px 25px; background-color: #007bff; color: white; border: none; border-radius: 7px; font-size: 16px; cursor: pointer;}
        #set-username-btn:disabled { opacity: 0.5; cursor: not-allowed;}
        #chat-form { display: flex; justify-content: center; gap: 15px; width: 65%; margin-bottom: 100px;}
        #chat-form input, #chat-form button { padding: 10px; font-size: 16px;}
        #chat-form input { width: 70%; }
        #chat-form button { width: 25%; background-color: #5cb85c; color: white; border: none; border-radius: 6px; cursor: pointer;}
        #chat-form button:hover { background-color: #4cae4c; }
        .star { color: #e53935; font-size: 18px; margin-left: 5px; }
        .disabled { background-color: #ddd !important; cursor: not-allowed !important;}
    </style>
</head>
<body>
    <div class="main-container">
        ...
        <div id="username-locked-msg" style="display:none;margin-bottom:22px;color:#333;font-weight:bold;"></div>
        <div id="chat-container">
            <div id="chat-box"></div>
            <form id="chat-form" autocomplete="off" style="display:none;">
